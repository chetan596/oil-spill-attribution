...
export default function InvestigationGuide({
  ...
  const steps = [
    ...
    },
    {
      ...
      details: `Advection equations (1.00·V_current + 0.03·V_wind) reverse-transport particles 24 hours to estimated release point ${driftData?.originLat != null && driftData?.originLng != null ? `[${Number(driftData.originLat).toFixed(4)}°N, ${Number(driftData.originLng).toFixed(4)}°E]` : '[LOCATION NOT ESTABLISHED]'} with ±${driftData?.uncertaintyRadiusKm != null ? Number(driftData.uncertaintyRadiusKm).toFixed(1) : '2.6'} km uncertainty.`,
