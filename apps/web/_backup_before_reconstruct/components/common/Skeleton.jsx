  ...
  return (
    <div
      ...
      style={{
        ...
        border: '1px solid var(--gesso-border, #252529)',
        borderRadius: '8px',
        ...style,
      }}
      aria-hidden="true"
    ...
    >
      <div
        style={{
          ...
          alignItems: 'center',
          gap: '8px',
          color: 'var(--gesso-fg-subtle, #71717A)',
          fontSize: '0.85rem',
          fontFamily: 'var(--gesso-font-mono, monospace)',
          letterSpacing: '0.05em',
        }}
      >
        <div style={{ width: '48px', height: '48px', borderRadius: '50%', border: '2px dashed var(--gesso-border, #252529)' }} />
...
export function SkeletonTable({ rows = 4, cols = 4, className = '', style = {} }) {
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div style={{ display: 'flex', gap: '8px', borderBottom: '1px solid var(--gesso-border, #252529)', paddingBottom: '8px' }}>
