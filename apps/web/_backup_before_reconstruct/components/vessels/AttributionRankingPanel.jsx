    ...
    return (
      <div className="card" style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
          ...
          <EvidenceBadge classification="DEMONSTRATION" label="DEMO / SIMULATED" size="sm" />
        </div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--accent-cyan)', fontWeight: 700, fontSize: '0.80rem' }}>
            <Info size={14} />
          ...
          <p style={{ margin: 0, fontSize: '0.70rem', color: 'var(--text-muted)', lineHeight: 1.4 }}>
  ...
  return (
    <div className="card" style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      >
        ...
        <div>
          <strong style={{ color: 'var(--accent-amber)' }}>CANDIDATE VESSEL CORRELATION:</strong> Attribution score represents modelled correlation within the available evidence. It does NOT establish vessel responsibility, causation, or proof of discharge.
        </div>
      </div>
    </div>
  );
