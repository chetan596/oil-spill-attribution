    ...
    <div className="p-6 md:p-8 space-y-10 max-w-6xl mx-auto w-full">
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-2">
          <span className="text-xs font-mono font-medium text-[#A855F7] uppercase tracking-wider">
            SCOPE DARK DESIGN SYSTEM
          </span>
          <span className="text-[#5C5C63]">•</span>
          <EvidenceBadge type="OBSERVED" label="GROUND TRUTH TOKENS" size="xs" />
        </div>
        <h1 className="page-title text-3xl md:text-4xl font-display font-medium text-[#F5F5F5]">
          Ocean Guard AI Design System & Component Reference
        </h1>
        <p className="text-xs text-[#C8C8CE] max-w-2xl leading-relaxed">
          Operational maritime forensic UI primitives: Scope Dark palette (#0A0A0B canvas, #141416 surface, #A855F7 primary, #EC4899 synthesis), Hanken Grotesk + Schibsted Grotesk typography, 4px grid rhythm, and strict evidence provenance.
        </p>
      </div>

      {/* ── 1. COLOR TOKENS ────────────────────────────────────────────────── */}
      <section className="space-y-3">
        <h2 className="text-sm font-mono font-medium text-[#F5F5F5] uppercase tracking-wider">
          1. Color Palette Tokens
        </h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 font-mono text-xs">
          <div className="p-3 bg-[#0A0A0B] border border-[#252529] rounded-lg">
            <div className="w-full h-8 bg-[#0A0A0B] border border-[#252529] rounded mb-2" />
            <span className="text-[#F5F5F5] block">Canvas</span>
            <span className="text-[#5C5C63] text-[10px]">#0A0A0B</span>
          </div>

          <div className="p-3 bg-[#141416] border border-[#252529] rounded-lg">
            <div className="w-full h-8 bg-[#141416] border border-[#252529] rounded mb-2" />
            <span className="text-[#F5F5F5] block">Surface</span>
            <span className="text-[#5C5C63] text-[10px]">#141416</span>
          </div>

          <div className="p-3 bg-[#141416] border border-[#252529] rounded-lg">
            <div className="w-full h-8 bg-[#222224] rounded mb-2" />
            <span className="text-[#F5F5F5] block">Elevated</span>
            <span className="text-[#5C5C63] text-[10px]">#222224</span>
          </div>

          <div className="p-3 bg-[#141416] border border-[#252529] rounded-lg">
            <div className="w-full h-8 bg-[#A855F7] rounded mb-2" />
            <span className="text-[#F5F5F5] block">Primary Accent</span>
            <span className="text-[#5C5C63] text-[10px]">#A855F7</span>
          </div>

          <div className="p-3 bg-[#141416] border border-[#252529] rounded-lg">
            <div className="w-full h-8 bg-[#EC4899] rounded mb-2" />
            <span className="text-[#F5F5F5] block">Synthesis Accent</span>
            <span className="text-[#5C5C63] text-[10px]">#EC4899</span>
          </div>

          <div className="p-3 bg-[#141416] border border-[#252529] rounded-lg">
            <div className="w-full h-8 bg-[#1AE8A0] rounded mb-2" />
            <span className="text-[#F5F5F5] block">Success</span>
            <span className="text-[#5C5C63] text-[10px]">#1AE8A0</span>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-3">
        ...
        <div className="p-5 bg-[#141416] border border-[#252529] rounded-lg flex items-center gap-4 flex-wrap">
      ...
      <section className="space-y-3">
        ...
        <div className="p-5 bg-[#141416] border border-[#252529] rounded-lg flex items-center gap-3 flex-wrap">
      ...
      <section className="space-y-3">
        ...
        <div className="p-5 bg-[#141416] border border-[#252529] rounded-lg">
          <MetricStrip
            metrics={[
      ...
      <Modal
        ...
        title="Generic Scope Dark Modal"
        subtitle="Forensic Inspection Dialog"
      >
        <p className="text-xs text-[#C8C8CE] leading-relaxed">
          Standard dialog container with focus trap, backdrop blur, and escape key listener.
        </p>
      </Modal>
    </div>
  );
