...
export default function DossierExcerpt({
  ...
  return (
    <section
      className={`panel dossier p-5 md:p-6 bg-[#141416] border border-[#252529] rounded-lg ${className}`}
      data-component="DossierExcerpt"
      data-brief-id="dossier-excerpt"
      data-brief-role="section"
    >
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-medium text-[#e8e8ea] font-display tracking-wide">
          {title}
        </h2>
        <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[rgba(236,72,153,0.12)] text-[#EC4899] uppercase tracking-wider">
          SYNTHESIS
        </span>
      </div>

      <p className="text-xs text-[#C8C8CE] leading-relaxed mt-2 max-w-4xl">
